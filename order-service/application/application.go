...
import (
	...
	"github.com/BernardN38/ebuy-server/order-service/handler"
...
func New() *Application {
	...
	orderService, err := service.New(db, rabbitmqEmitter)
	if err != nil {
		log.Fatalln(err)
		return &Application{}
	}
	handler := handler.New(orderService)
